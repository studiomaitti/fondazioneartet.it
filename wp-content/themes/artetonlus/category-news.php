...
<div id="primary" class="content-area">
    ...
    <?php if ( is_active_sidebar( 'under-category-news-list' ) ) : ?>
        <aside id="under-category-news-list" class="sidebar widget-area" role="complementary">
            <?php dynamic_sidebar( 'under-category-news-list' ); ?>
